 ...
 */
@FunctionalInterface
public interface Func2<In1, In2, Out> extends Func<Tuple2<In1, In2>, Out> , BiFunction<In1, In2, Out> {
	...
	@Override
	default <Last> Func2<In1, In2, Last> andThen(Function<? super Out, ? extends Last> after) {
		return (in1, in2) -> after.apply(apply(in1, in2));
	}
